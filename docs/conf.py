# -*- coding: utf-8 -*-
#
# PySeps documentation build configuration file, created by
...
MOCK_MODULES = ['wishbone','gevent_inotifyx','PyYAML' ]
...
latex_documents = [
  ('index', 'PySeps.tex', u'PySeps Documentation',
   u'Jelle Smet', 'manual'),
]
...
man_pages = [
    ('index', 'wishbone', u'PySeps Documentation',
     [u'Jelle Smet'], 1)
]
...
texinfo_documents = [
  ('index', 'PySeps', u'PySeps Documentation',
   u'Jelle Smet', 'PySeps', 'One line description of project.',
   'Miscellaneous'),
]
